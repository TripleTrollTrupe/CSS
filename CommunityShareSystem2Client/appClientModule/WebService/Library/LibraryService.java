 ...
 * 
 */
@WebServiceClient(name = "LibraryService", targetNamespace = "http://lendables.model/", wsdlLocation = "http://localhost:8080/LibraryService/Library?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LIBRARYSERVICE_QNAME = new QName("http://lendables.model/", "LibraryService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/LibraryService/Library?wsdl");
     ...
     * 
     * @return
     *     returns LibraryHandlerRemote
     */
    @WebEndpoint(name = "LibraryPort")
    public LibraryHandlerRemote getLibraryPort() {
        return super.getPort(new QName("http://lendables.model/", "LibraryPort"), LibraryHandlerRemote.class);
    }
     ...
     */
    @WebEndpoint(name = "LibraryPort")
    public LibraryHandlerRemote getLibraryPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://lendables.model/", "LibraryPort"), LibraryHandlerRemote.class, features);
    }
